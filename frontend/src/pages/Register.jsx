...
import { UserPlus, User, Mail, Lock, UserCircle, ShieldCheck, Car } from 'lucide-react';
                ...
                <div style={{
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                        ...
                        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                            Join AutoSCM to start comparing vehicles
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <UserCircle size={16} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)', pointerEvents: 'none' }} />
                                <input
                                    type="text" required
